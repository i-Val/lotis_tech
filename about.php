        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-lg-6 pr-lg-5">
                    ...
                    LotisTech is a mordern software company aimed at delivering software at the highest excellence. We are dedicated to delivering professional services; within the clients budget. 
                    </p>
                </div>
                <div class="col-lg-6">
                    <p class="lead lh-180">
                    We partner with you to understand your needs better.
                    </p>
                    <p class="lead lh-180">
                    We take your through the best process to creating the future as you see it
                    </p>
                </div>
            </div>
        </div>
